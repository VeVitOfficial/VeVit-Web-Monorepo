...
// ── i18n bootstrap ──────────────────────────────────────────────────────
// Každý store request (page i API) dostává resolving locale a zaregistrovaný
// slovník store/lang/*.php. vv_t() pak vrací lokalizované řetězce; fallback cs.
require_once dirname(__DIR__) . '/shared/i18n/locale.php';
vv_i18n_register(__DIR__ . '/lang');
vv_i18n_set_lang(vv_resolve_locale());
