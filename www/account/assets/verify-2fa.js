(function initTwoFactorVerification() {
  ...
  toggle.addEventListener('click', () => {
    ...
    description.textContent = recovery ? 'Zadejte jeden nepoužitý obnovovací kód.' : 'Zadejte šestimístný kód z ověřovací aplikace.';
    toggle.textContent = recovery ? 'Použít kód z aplikace' : 'Použít obnovovací kód';
    code.focus();
  });
