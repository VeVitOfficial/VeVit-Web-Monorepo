...
$pdo->prepare("INSERT INTO courses (slug,title,description,icon,color,total_xp,estimated_hours,difficulty) VALUES (?,?,?,?,?,?,?,?)")
    ->execute(['ai-gramotnost','AI Gramotnost','Kompletní kurz AI gramotnosti – od základů po pokročilé techniky prompt engineeringu a integrace AI nástrojů.','brain','#8B5CF6',0,20,'beginner']);
