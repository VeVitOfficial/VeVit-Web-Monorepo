...
function contentData() {
  ...
  $course = ['id' => 1, 'slug' => 'ai-gramotnost', 'title' => 'AI Gramotnost', 'description' => 'Kompletní kurz AI gramotnosti – od základů po pokročilé techniky prompt engineeringu a integrace AI nástrojů.', 'icon' => 'brain', 'color' => '#8B5CF6', 'estimated_hours' => 20, 'difficulty' => 'beginner', 'total_xp' => 0];
