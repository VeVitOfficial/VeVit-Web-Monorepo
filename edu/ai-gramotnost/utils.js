...
function formatXP(n) { return Number(n || 0).toLocaleString("cs-CZ"); }
...
// Vykreslí lucide-style ikonu jako inline SVG (malá sada použitá v app)
const Icons = {
  ...
  flame: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2c1 3-2 5-2 8a4 4 0 0 0 8 0c0-1-.5-2-1-3 2 1 4 3 4 7a7 7 0 1 1-14 0c0-5 5-7 5-12z"/></svg>',
