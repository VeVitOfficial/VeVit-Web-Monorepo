...
import { getCourseBySlug } from "../lib/api.js?v=20260824c";
import { getProgress } from "../store/progress.js";
import { t, lessonsUnit } from "../store/lang.js?v=20260824a";
...
export async function renderCourse(slug) {
  ...
  const { course } = data;
  const lang = (await import("../store/lang.js?v=20260824a")).currentLang();
