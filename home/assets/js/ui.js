    ...
    translations: {
        cs: {
            ...
            page: {
                ...
                hero: { eyebrow: 'Český digitální ekosystém', h1a: 'Nástroje, hry', h1b: 'a lekce.', h1c: 'Bez reklam.', sub: '21+ her a 500+ lekcí. Nástroje můžeš používat přímo v prohlížeči.', ctaTools: 'Otevřít Tools', ctaExplore: 'Prozkoumat ekosystém', metaTools: 'nástrojů', metaGames: 'her', metaLessons: 'lekcí', metaUsers: 'uživatelů' },
                marquee: { games: '21+ HER', lessons: '500+ LEKCÍ', users: '1 200+ UŽIVATELŮ', noAds: 'BEZ REKLAM', local: 'VŠE LOKÁLNĚ V PROHLÍŽEČI', cz: 'POSTAVENO V ČR' },
                ...
                stats: { aria: 'Statistiky komunity', items: [ { label: 'XP rozdáno', delta: '+12.4 % týden', desc: 'Napříč všemi aplikacemi' }, { label: 'Lekce dokončeny', delta: '+8.1 % týden', desc: 'V Edu sekci, 142 kurzů' }, { label: 'Aktivní uživatelé', delta: '+2.7 % týden', desc: 'Měsíčně, MAU' }, { label: 'Vyřešeno úloh', delta: '+14.9 % týden', desc: 'Tools, AI, kalkulačky' } ] },
        ...
        en: {
            ...
            page: {
                ...
                hero: { eyebrow: 'Czech digital ecosystem', h1a: 'Tools, games', h1b: 'and lessons.', h1c: 'No ads.', sub: '21+ games and 500+ lessons. Tools run right in your browser.', ctaTools: 'Open Tools', ctaExplore: 'Explore the ecosystem', metaTools: 'tools', metaGames: 'games', metaLessons: 'lessons', metaUsers: 'users' },
                marquee: { games: '21+ GAMES', lessons: '500+ LESSONS', users: '1,200+ USERS', noAds: 'NO ADS', local: 'ALL LOCAL IN THE BROWSER', cz: 'BUILT IN CZ' },
                ...
                stats: { aria: 'Community stats', items: [ { label: 'XP awarded', delta: '+12.4 % week', desc: 'Across all apps' }, { label: 'Lessons completed', delta: '+8.1 % week', desc: 'In the Edu section, 142 courses' }, { label: 'Active users', delta: '+2.7 % week', desc: 'Monthly, MAU' }, { label: 'Tasks solved', delta: '+14.9 % week', desc: 'Tools, AI, calculators' } ] },
        ...
        es: {
            ...
            page: {
                ...
                hero: { eyebrow: 'Ecosistema digital checo', h1a: 'Herramientas, juegos', h1b: 'y lecciones.', h1c: 'Sin anuncios.', sub: '21+ juegos y 500+ lecciones. Las herramientas funcionan directamente en el navegador.', ctaTools: 'Abrir Tools', ctaExplore: 'Explorar el ecosistema', metaTools: 'herramientas', metaGames: 'juegos', metaLessons: 'lecciones', metaUsers: 'usuarios' },
                marquee: { games: '21+ JUEGOS', lessons: '500+ LECCIONES', users: '1.200+ USUARIOS', noAds: 'SIN ANUNCIOS', local: 'TODO LOCAL EN EL NAVEGADOR', cz: 'HECHO EN CZ' },
                ...
                platforms: { eyebrow: 'Ecosistema', title: 'Apps web', subtitle: 'Cada app tiene su propio enfoque. VeVit Account las conecta poco a poco.', badgeBeta: 'Pruebas beta', toolsDesc: 'Calculadoras, conversores, generadores, herramientas PDF, asistentes de IA y utilidades dev. Las herramientas funcionan localmente en el navegador. No hace falta subir archivos.', gamesDesc: 'Preparamos 21+ juegos, incluidos Snake, Tetris, Pac-Man y 2048.', gamesMeta: 'juegos disponibles', eduDesc: '500+ lecciones, cuestionarios y artículos. Programación, matemáticas, idiomas.', eduMeta: 'lecciones gratis', searchDesc: 'Búsqueda universal en todo el ecosistema VeVit.', storeDesc: 'Merch oficial, productos digitales y planes Premium.' },
                ...
                stats: { aria: 'Estadísticas de la comunidad', items: [ { label: 'XP repartido', delta: '+12,4 % semana', desc: 'En todas las apps' }, { label: 'Lecciones completadas', delta: '+8,1 % semana', desc: 'En la sección Edu, 142 cursos' }, { label: 'Usuarios activos', delta: '+2,7 % semana', desc: 'Mensualmente, MAU' }, { label: 'Tareas resueltas', delta: '+14,9 % semana', desc: 'Tools, IA, calculadoras' } ] },
                ...
                footer: { colPlatforms: 'Plataformas', colAccount: 'Cuenta', colSupport: 'Soporte', linkGames: 'Juegos', linkTools: 'Herramientas', linkEdu: 'Educación', linkServices: 'Servicios', linkLogin: 'Inicio de sesión', linkRegister: 'Registro', linkDashboard: 'Panel', linkContact: 'Contacto', linkFaq: 'FAQ', linkSupport: 'Soporte', socialsAria: 'Redes sociales', copy: 'Hecho con', madeIn: 'en Chequia.' },
        ...
        de: {
            ...
            page: {
                ...
                hero: { eyebrow: 'Tschechisches digitales Ökosystem', h1a: 'Tools, Spiele', h1b: 'und Lektionen.', h1c: 'Ohne Werbung.', sub: '21+ Spiele und 500+ Lektionen. Tools laufen direkt im Browser.', ctaTools: 'Tools öffnen', ctaExplore: 'Ökosystem entdecken', metaTools: 'Tools', metaGames: 'Spiele', metaLessons: 'Lektionen', metaUsers: 'Nutzer' },
                marquee: { games: '21+ SPIELE', lessons: '500+ LEKTIONEN', users: '1.200+ NUTZER', noAds: 'OHNE WERBUNG', local: 'ALLES LOKAL IM BROWSER', cz: 'IN CZ GEMACHT' },
                ...
                stats: { aria: 'Community-Statistiken', items: [ { label: 'XP vergeben', delta: '+12,4 % Woche', desc: 'Über alle Apps' }, { label: 'Lektionen abgeschlossen', delta: '+8,1 % Woche', desc: 'Im Edu-Bereich, 142 Kurse' }, { label: 'Aktive Nutzer', delta: '+2,7 % Woche', desc: 'Monatlich, MAU' }, { label: 'Aufgaben gelöst', delta: '+14,9 % Woche', desc: 'Tools, AI, Rechner' } ] },
        ...
        uk: {
            ...
            page: {
                ...
                hero: { eyebrow: 'Чеська цифрова екосистема', h1a: 'Інструменти, ігри', h1b: 'і уроки.', h1c: 'Без реклами.', sub: '21+ ігор і 500+ уроків. Інструменти працюють прямо в браузері.', ctaTools: 'Відкрити Tools', ctaExplore: 'Оглянути екосистему', metaTools: 'інструментів', metaGames: 'ігор', metaLessons: 'уроків', metaUsers: 'користувачів' },
                marquee: { games: '21+ ІГОР', lessons: '500+ УРОКІВ', users: '1 200+ КОРИСТУВАЧІВ', noAds: 'БЕЗ РЕКЛАМИ', local: 'УСЕ ЛОКАЛЬНО В БРАУЗЕРІ', cz: 'ЗРОБЛЕНО В ЧЕХІЇ' },
                ...
                stats: { aria: 'Статистика спільноти', items: [ { label: 'Видано XP', delta: '+12,4 % за тиждень', desc: 'У всіх додатках' }, { label: 'Уроки завершено', delta: '+8,1 % за тиждень', desc: 'У розділі Edu, 142 курси' }, { label: 'Активні користувачі', delta: '+2,7 % за тиждень', desc: 'Щомісяця, MAU' }, { label: 'Вирішено завдань', delta: '+14,9 % за тиждень', desc: 'Tools, AI, калькулятори' } ] },
        ...
        fr: {
            ...
            page: {
                ...
                hero: { eyebrow: 'Écosystème numérique tchèque', h1a: 'Outils, jeux', h1b: 'et leçons.', h1c: 'Sans publicités.', sub: '21+ jeux et 500+ leçons. Les outils fonctionnent directement dans le navigateur.', ctaTools: 'Ouvrir Tools', ctaExplore: 'Explorer l\'écosystème', metaTools: 'outils', metaGames: 'jeux', metaLessons: 'leçons', metaUsers: 'utilisateurs' },
                marquee: { games: '21+ JEUX', lessons: '500+ LEÇONS', users: '1 200+ UTILISATEURS', noAds: 'SANS PUB', local: 'TOUT LOCAL DANS LE NAVIGATEUR', cz: 'CONÇU EN CZ' },
                ...
                stats: { aria: 'Statistiques de la communauté', items: [ { label: 'XP distribués', delta: '+12,4 % semaine', desc: 'Sur toutes les apps' }, { label: 'Leçons terminées', delta: '+8,1 % semaine', desc: 'Dans la section Edu, 142 cours' }, { label: 'Utilisateurs actifs', delta: '+2,7 % semaine', desc: 'Mensuellement, MAU' }, { label: 'Tâches résolues', delta: '+14,9 % semaine', desc: 'Tools, IA, calculatrices' } ] },
        ...
        sk: {
            ...
            page: {
                ...
                hero: { eyebrow: 'Český digitálny ekosystém', h1a: 'Nástroje, hry', h1b: 'a lekcie.', h1c: 'Bez reklám.', sub: '21+ hier a 500+ lekcií. Nástroje môžeš používať priamo v prehliadači.', ctaTools: 'Otvoriť Tools', ctaExplore: 'Preskúmať ekosystém', metaTools: 'nástrojov', metaGames: 'hier', metaLessons: 'lekcií', metaUsers: 'používateľov' },
                marquee: { games: '21+ HIER', lessons: '500+ LEKCIÍ', users: '1 200+ POUŽÍVATEĽOV', noAds: 'BEZ REKLÁM', local: 'VŠETKO LOKÁLNE V PREHLIADAČI', cz: 'POSTAVENÉ V CZ' },
                ...
                stats: { aria: 'Štatistiky komunity', items: [ { label: 'XP rozdané', delta: '+12,4 % týždeň', desc: 'Naprieč všetkými aplikáciami' }, { label: 'Lekcie dokončené', delta: '+8,1 % týždeň', desc: 'V Edu sekcii, 142 kurzov' }, { label: 'Aktívni používatelia', delta: '+2,7 % týždeň', desc: 'Mesačne, MAU' }, { label: 'Vyriešené úlohy', delta: '+14,9 % týždeň', desc: 'Tools, AI, kalkulačky' } ] },
