<div class="stack" style="max-width:46rem;margin:0 auto">
  <div class="stack-sm">
    <label class="field-label" for="jwg-secret"><?= e(vv_t('jwt_generator.secret', $lang)) ?></label>
  ...
  <div class="row" style="flex-wrap:wrap;gap:0.5rem">
    <button class="btn btn-primary" id="jwg-gen" type="button"><?= icon_svg('FileKey', 16) ?> <?= e(vv_t('jwt_generator.generate', $lang)) ?></button>
  </div>
  <div class="stack-sm">
    ...
    <div class="row" style="flex-wrap:wrap;gap:0.5rem">
      <button class="btn btn-secondary" id="jwg-copy" type="button" disabled><?= icon_svg('Copy', 16) ?> <?= e(vv_t('tool_common.copy', $lang)) ?></button>
    </div>
  </div>
  <p class="error-text hidden" id="jwg-error" role="alert"></p>
  <p class="muted" style="font-size:0.8rem"><?= e(vv_t('jwt_generator.footer', $lang)) ?></p>
</div>