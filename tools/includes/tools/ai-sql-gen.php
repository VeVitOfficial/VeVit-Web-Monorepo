<div class="stack" style="max-width:46rem;margin:0 auto">
  ...
  <div class="stack-sm"><label class="field-label" for="sql-dialect"><?= e(vv_t('ai_sql_gen.dialect', $lang)) ?></label>
  ...
  <textarea class="textarea" id="sql-input" rows="8" placeholder="<?= e(vv_t('ai_sql_gen.placeholder', $lang)) ?>"></textarea>
  <button class="btn btn-primary btn-touch" id="sql-run" type="button"><?= icon_svg('Database', 18) ?> <span class="sql-label"><?= e(vv_t('ai_sql_gen.run', $lang)) ?></span><span class="sql-stop hidden"><?= e(vv_t('tool_common.stop', $lang)) ?></span></button>
  ...
  <div class="result-card hidden" id="sql-out">
    ...
    <div class="row" style="gap:0.5rem;margin-top:0.75rem"><button class="btn btn-secondary btn-sm" id="sql-copy" type="button"><?= icon_svg('Copy', 14) ?> <?= e(vv_t('tool_common.copy', $lang)) ?></button></div>
  </div>
  <p class="muted" style="font-size:0.8rem"><?= e(vv_t('ai_sql_gen.footer', $lang)) ?></p>
</div>
